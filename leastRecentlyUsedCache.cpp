...
class LRUCache {
    ...
    Attributes:
        ...
        oldest: (Sentinel node) the oldest node (least recently used), towards the right, Node*
        newest: (Sentinel node) the newest node (most recently used), towards the left, Node*
    ...
    public:
        ...
        void addNode(Node* current_newest){
            ...
            */
            ...
            //Get the node that the newest sentinel is pointin to
